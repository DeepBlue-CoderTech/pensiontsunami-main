...
<head>
	<title>Public Pension News &raquo; Pension Tsunami</title>
...
<?php include("includes/side.php"); ?>
			...
			<div id="right">
			<h2>Public Pensions News <span class="up"> &nbsp;&nbsp;&nbsp;&nbsp;last updated <?php lastUpdate() ?> PST</span></h2>
