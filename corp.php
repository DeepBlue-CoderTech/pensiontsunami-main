...
<head>
	<title>Corporate Pension News &raquo; Pension Tsunami</title>
...
<div id="subscribe">
	...
	<div id="header">
  <?php include("includes/header_corp.php"); ?>
	</div>
</div>
	<div id="main">
<?php include("includes/side.php"); ?>
			...
			<div id="right">
			<h2>Corporate Pensions News <span class="up"> &nbsp;&nbsp;&nbsp;&nbsp;last updated <?php lastUpdate() ?> PST</span></h2>
