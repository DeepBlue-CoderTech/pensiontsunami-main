...
<head>
	<title>About Pension Tsunami</title>
...
<div id="subscribe">
	...
	<div id="header">
  <?php include("includes/header_about.php"); ?>
	</div>
</div>
	<div id="main">
...
{
	if($_GET['message'] == 'inq') $message = '<strong>You have successfully contacted the site Editor.  We will get back to you ASAP!</strong>';
...
<p>PensionTsunami's primary focus is on California's public employee pension crisis, but we also monitor developments in all three pension spheres nationwide -- public employees, corporations and social 
security -- since it is taxpayers who will ultimately be responsible for making up deficits incurred by any of them.  We also try to monitor international 
trends.  The site was launched in 2005 under the auspices of the <a href="http://www.fullertontaxpayers.org">Fullerton Association of Concerned Taxpayers</a>.</p>
<h2>Contact</h2>
<p>Feel free to e-mail the editor of PensionTsunami, Jack Dean, at JackDean@PensionTsunami.com.</p>
